...
const handleSubmit = () => {
  ...
  type.value == "auth" ? login() : register();
};
  ...
  <div class="auth-block-1">
    ...
    <div class="mt-2 mb-2" v-if="type === 'register'">
      <input
        v-model="email"
        type="email"
        :placeholder="$t('general.auth.credentials.email')"
      />
    </div>
    <div class="mt-2 mb-2">
      <input
        v-model="loginName"
        type="text"
        :placeholder="$t('general.auth.credentials.login')"
      />
    </div>
    <div class="mt-2 mb-2">
      <input
        v-model="password"
        type="password"
        :placeholder="$t('general.auth.credentials.password')"
      />
    </div>
